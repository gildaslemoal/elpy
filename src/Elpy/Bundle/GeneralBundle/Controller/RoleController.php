...
use Elpy\Bundle\GeneralBundle\Entity\Role;
use Elpy\Bundle\GeneralBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ElpyGeneralBundle:Role')->findAll();

        return $this->render('ElpyGeneralBundle:Role:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ElpyGeneralBundle:Role:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ElpyGeneralBundle:Role')->find($id);
        ...
        return $this->render('ElpyGeneralBundle:Role:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ElpyGeneralBundle:Role:edit.html.twig', array(
            'entity'      => $entity,
